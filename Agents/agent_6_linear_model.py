...
class LinearAgent(Core):
    ...
    def __init__(self, train_data_length=20, predict_ahead=2, **kwargs):
        super().__init__(**kwargs)
        assert self.rets_length > (1 + predict_ahead), f"Rets length must be greater than 1+{predict_ahead}."
